...
//		Customer CRUD operation
		...
		c.setPhone("8384837741");
		c.setEmail("prathas@gmail.com");
...
//		MallAdmin CRUD operation
		...
		ma.setPassword("pass123");
		ma.setPhone("8384837741");
...
//		ShopOwner CRUD operation
		...
		LocalDate date2 = LocalDate.of(2001, 01, 25);
		so.setDob(date2);
		so.setAddress("Thane");
...
//   	**********  Association Starts Here  **********
		...
		CustomerServiceImpl csi1 = new CustomerServiceImpl();
		EmployeeServiceImpl esi1 = new EmployeeServiceImpl();
		OrderServiceImpl osi1 = new OrderServiceImpl();
...
//		-------------  Update Employee------------------------------------------------------------------------------------------>
		...
		EmployeeServiceImpl oesi = new EmployeeServiceImpl();
		ShopServiceImpl ossi = new ShopServiceImpl();
...
//		--------------  Search Employee------------------------------------------------------------------------------------------>
		...
		EmployeeServiceImpl oesi1 = new EmployeeServiceImpl();
